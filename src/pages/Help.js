...
const Help = () => {
  const booking_help = [
    {
      heading: "Q: How do I book an equipment on Krishi Sarthi",
      content:
  ...
  const renting_help = [
    ...
    },
    {
      ...
      content:
        "A: You can post all types of farming eqipment on Krishi Sarthi. For Example, Trucks, Tractors, etc.",
    },
  ];
      ...
      <div className="w-100">
        <div className="p-9 flex w-screen">
          ...
          <button className="px-6 py-1 rounded-lg ml-auto text-white text-xl font-semibold hover:bg-green-700 bg-[#68AC5D]">
            <Link to="/contact">
              <p className="px-6 py-1 rounded-lg ml-auto text-white text-xl font-semibold hover:bg-green-700 bg-[#68AC5D]">
                Contact Us
              </p>
              </Link>{" "}
          </button>
